...
SOURCES += src/activemasternode.cpp \
           ...
           src/qt/mirageconfig.cpp \
           src/qt/yup.cpp \
           src/qt/yupstrings.cpp \
...
RESOURCES += src/qt/yup.qrc src/qt/yup_locale.qrc

TRANSLATIONS += src/qt/locale/yup_bg.ts \
                src/qt/locale/yup_de.ts \
                src/qt/locale/yup_en.ts \
                src/qt/locale/yup_es.ts \
                src/qt/locale/yup_fi.ts \
                src/qt/locale/yup_fr.ts \
                src/qt/locale/yup_it.ts \
                src/qt/locale/yup_ja.ts \
                src/qt/locale/yup_pl.ts \
                src/qt/locale/yup_pt.ts \
                src/qt/locale/yup_ru.ts \
                src/qt/locale/yup_sk.ts \
                src/qt/locale/yup_sv.ts \
                src/qt/locale/yup_vi.ts \
                src/qt/locale/yup_zh_CN.ts \
                src/qt/locale/yup_zh_TW.ts
