Contributing to YUP Core
============================

The YUP Core project operates an open contributor model where anyone is
...
The following applies to code changes to the YUP Core project, and is not to be
confused with overall YUP Network Protocol consensus changes.

Whether a pull request is merged into YUP Core rests with the project merge
...
Patches that change YUP consensus rules are considerably more involved than
...
Where a patch set proposes to change the YUP consensus, it must have been
...
The project leader is the release manager for each YUP Core release.
