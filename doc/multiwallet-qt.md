...
In order to support loading of multiple wallets in yup-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is yup.cpp.
...
Changes to yup.cpp
----------------------
yup.cpp is the entry point into yup-qt, and as such, will require some minor modifications to provide hooks for
