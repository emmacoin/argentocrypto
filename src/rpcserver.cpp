...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Yup features */
        {"yup", "masternode", &masternode, true, true, false},
        {"yup", "listmasternodes", &listmasternodes, true, true, false},
        {"yup", "getmasternodecount", &getmasternodecount, true, true, false},
        {"yup", "masternodeconnect", &masternodeconnect, true, true, false},
        {"yup", "masternodecurrent", &masternodecurrent, true, true, false},
        {"yup", "masternodedebug", &masternodedebug, true, true, false},
        {"yup", "startmasternode", &startmasternode, true, true, false},
        {"yup", "createmasternodekey", &createmasternodekey, true, true, false},
        {"yup", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"yup", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"yup", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"yup", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"yup", "getmasternodescores", &getmasternodescores, true, true, false},
        {"yup", "mnbudget", &mnbudget, true, true, false},
        {"yup", "preparebudget", &preparebudget, true, true, false},
        {"yup", "submitbudget", &submitbudget, true, true, false},
        {"yup", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"yup", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"yup", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"yup", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"yup", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"yup", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"yup", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"yup", "checkbudgets", &checkbudgets, true, true, false},
        {"yup", "mnsync", &mnsync, true, true, false},
        {"yup", "spork", &spork, true, true, false},
        {"yup", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"yup", "mirage", &mirage, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use yupd, or the -server option to yup-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> yup-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:1238/\n";
}
