                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Miraged"), TransactionFilterProxy::TYPE(TransactionRecord::Miraged));
    typeWidget->addItem(tr("Mirage Make Collateral Inputs"), TransactionFilterProxy::TYPE(TransactionRecord::MirageMakeCollaterals));
    typeWidget->addItem(tr("Mirage Create Denominations"), TransactionFilterProxy::TYPE(TransactionRecord::MirageCreateDenominations));
    typeWidget->addItem(tr("Mirage Denominate"), TransactionFilterProxy::TYPE(TransactionRecord::MirageDenominate));
    typeWidget->addItem(tr("Mirage Collateral Payment"), TransactionFilterProxy::TYPE(TransactionRecord::MirageCollateralPayment));
