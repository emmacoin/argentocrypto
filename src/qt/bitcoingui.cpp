                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("YUP Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a YUP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and yup: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About YUP Core"), this);
    aboutAction->setStatusTip(tr("Show information about YUP Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for YUP"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your YUP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified YUP addresses"));
    ...
    openAction->setStatusTip(tr("Open a YUP: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the YUP Core help message to get a list with possible YUP command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("YUP Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to YUP network", "", count));
}
...
{
    QString strTitle = tr("YUP Core"); // default title
