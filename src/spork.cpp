...
// Copyright (c) 2016-2017 The YUP developers
...
bool CSporkManager::CheckSignature(CSporkMessage& spork)
{
    ...
    if (!miRageSigner.VerifyMessage(pubkey, spork.vchSig, strMessage, errorMessage)) {
        return false;
    }
...
bool CSporkManager::Sign(CSporkMessage& spork)
{
    ...
    if (!miRageSigner.SetKey(strMasterPrivKey, errorMessage, key2, pubkey2)) {
        LogPrintf("CMasternodePayments::Sign - ERROR: Invalid masternodeprivkey: '%s'\n", errorMessage);
        return false;
    }

    if (!miRageSigner.SignMessage(strMessage, errorMessage, spork.vchSig, key2)) {
        LogPrintf("CMasternodePayments::Sign - Sign message failed");
        return false;
    }

    if (!miRageSigner.VerifyMessage(pubkey2, spork.vchSig, strMessage, errorMessage)) {
